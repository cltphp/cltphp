...
MySQL - 5.7.17 : Database - cltdemo_db
*********************************************************************
*/
...
CREATE TABLE `ad` (
  ...
  PRIMARY KEY (`id`),
  KEY `plug_ad_adtypeid` (`as_id`)
) ENGINE=MyISAM AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='广告表';

/*Data for the table `ad` */

insert  into `ad`(`id`,`title`,`as_id`,`pic`,`url`,`addtime`,`sort`,`open`,`content`) values 
(15,'简单、高效、简洁',1,'/uploads/20190305/b3607f45c4f6cf56456edbe3ab096e1a.jpg','http://demo.cltphp.com',1480909037,1,1,'虽然世界上有成千上万的建站系统，但CLTPHP会告诉你，真正高效的建站系统是什么样的。'),
(17,'集万千宠爱于一身',1,'/uploads/20190305/959887756be1af9bcc1a78ca0565fc8d.jpg','http://demo.cltphp.com',1481788850,2,1,'CLTPHP采用了优美的layui框架，一面极简，一面丰盈。加上angular Js，让数据交互变得更为简洁直白。用最基础的代码，实现最强大的效果，让你欲罢不能！'),
(18,'精益求精',1,'/uploads/20190305/b043970c33f6a88529b332b4c5d0727b.jpg','http://demo.cltphp.com',1481788869,3,1,'CLTPHP采用的ThinkPHP5为基础框架，从而使得CLTPHP的拓展性变的极为强大。从模型构造到栏目建立，再到前台展示，一气呵成，网站后台一条龙式操作，让小白用户能快速掌握CLTPHP管理系统的核心操作，让小白开发者能更好的理解CLTPHP的核心构建价值。'),
(36,'虚席以待',5,'','http://show.cltphp.com',1551769792,50,1,'');
...
(1,'admin','0192023a7bbd73250516f069df18b500',1,'1109305454@qq.com','','18792402229','127.0.0.1',1482132862,'0',1,'/uploads/20180625/f266169c2956429d9aaea6cf6f1e51cb.jpg'),
(11,'cltphp','2495caa2aa678121ccc248e530494639',2,'123@qq.com','','15896589568','127.0.0.1',1535512393,'0',1,'');
...
insert  into `article`(`id`,`catid`,`userid`,`username`,`title`,`keywords`,`description`,`content`,`template`,`posid`,`status`,`recommend`,`readgroup`,`readpoint`,`sort`,`hits`,`createtime`,`updatetime`,`copyfrom`,`fromlink`,`thumb`,`title_style`,`tags`) values 
...
(2,'管理员',1,'0,1,2,270,15,16,145,17,181,18,111,3,5,127,128,4,129,189,190,239,241,242,7,9,14,234,13,235,236,237,27,29,161,163,164,162,38,167,182,169,166,28,48,31,32,45,174,46,179,196,197,202,252,203,204,272,206,207,212,208,260,209,215,267,269,',1465114224),
...
(267,'Plugin/index','插件管理',1,1,1,'icon-power-cord','',0,9,1501466560,0,1),
...
(62,'smtp_user','1109305556@qq.com','smtp','0'),
...
/*Data for the table `debris_type` */
...
insert  into `donation`(`id`,`name`,`money`,`addtime`) values 
...
insert  into `download`(`id`,`catid`,`userid`,`username`,`title`,`title_style`,`thumb`,`keywords`,`description`,`content`,`template`,`posid`,`status`,`recommend`,`readgroup`,`readpoint`,`sort`,`hits`,`createtime`,`updatetime`,`files`,`ext`,`size`,`downs`) values 
...
(4,14,1,'admin','测试下载二','color:;font-weight:normal;','','测试下载二','测试下载二','请输入……','0',2,1,0,'',0,0,0,1529638055,1534820130,'/uploads/20180803/d834d080f9c0080abaf9a7578ceea915.zip','zip','',0);
...
/*Data for the table `feast_element` */
...
insert  into `link`(`id`,`title`,`url`,`type_id`,`qq`,`sort`,`addtime`,`open`) values 
...
insert  into `message`(`message_id`,`title`,`tel`,`addtime`,`open`,`ip`,`content`,`name`,`email`) values 
...
insert  into `system`(`id`,`name`,`domain`,`title`,`key`,`des`,`bah`,`copyright`,`ads`,`tel`,`email`,`logo`,`mobile`,`code`) values 
(1,'CLTPHP','http://cltdemo.test/','CLTPHP','CLTPHP,CLTPHP内容管理系统,php','CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。','陕ICP备15008093号-3','2015-2020','西安市雁塔区','18792402256','1109305556@qq.com','/uploads/20190305/0f33002431b9c35ad0c8f6be8834c064.png','open','open');
...
insert  into `users`(`id`,`email`,`password`,`paypwd`,`sex`,`birthday`,`reg_time`,`last_login`,`last_ip`,`qq`,`mobile`,`mobile_validated`,`oauth`,`openid`,`unionid`,`avatar`,`province`,`city`,`district`,`email_validated`,`username`,`level`,`is_lock`,`token`,`sign`,`status`) values 
(1,'1109305987@qq.com','',NULL,1,0,1516075631,0,'','','44311',0,'',NULL,NULL,'/uploads/20180613/fcb729987d8e9339bd9b2e85c85f3028.jpg',24,311,2599,0,'chichu',1,0,'','不要应为走得太远，就忘了当初为什么出发！','hide'),
(2,'','e10adc3949ba59abbe56e057f20f883e',NULL,0,0,1542781390,0,'','','18092591522',1,'',NULL,NULL,NULL,0,0,0,0,'chichu',1,0,'','','hide');
...
/*Data for the table `wx_default_replay` */
...
/*Data for the table `wx_follow_replay` */
...
/*Data for the table `wx_key_replay` */

insert  into `wx_key_replay`(`id`,`instance_id`,`key`,`match_type`,`reply_media_id`,`sort`,`create_time`,`modify_time`) values 
...
insert  into `wx_media`(`media_id`,`title`,`instance_id`,`type`,`sort`,`create_time`,`modify_time`) values 
...
/*Data for the table `wx_media_item` */

insert  into `wx_media_item`(`id`,`media_id`,`title`,`author`,`cover`,`show_cover_pic`,`summary`,`content`,`content_source_url`,`sort`,`hits`) values 
...
(2,0,'SHOPWCHAT','{\"appid\":\"dfdsfdsf90bc7b7a\",\"appsecret\":\"e5147ce07128asdfds222f628b5c3fe1af2ea5797\",\"token\":\"dffdf\",\"qrcode\":\"\\/uploads\\/20190308\\/64e2362d3547682c437e8c72817ed0f5.png\",\"file\":\"\"}','',1,1497088090,1552013585,'/uploads/20190308/64e2362d3547682c437e8c72817ed0f5.png');
...
/*Data for the table `wx_user_msg` */
...
/*Data for the table `wx_user_msg_replay` */
